...
const EXTRACTION_PROMPT = `You extract a personal knowledge graph for Saphira (AI assistant) about Vector (her human partner) and their shared world.

Extract ONLY:
- Facts about Vector: interests, preferences, plans, events, relationships to people, personal traits
- Facts about Saphira: decisions, development, rules that apply between them
- Real people, places, organizations mentioned in conversation
- Concrete plans/projects (e.g. "Vector plans Furvaria event in May")
- Relationship facts (e.g. "Vector loves Guin", "Vector is member of Münchner Furs")

Return an EMPTY JSON ({"entities":[],"relationships":[]}) if the text contains:
- Technical content, code, shell commands, API calls
- Skill descriptions, documentation, SKILL.md content
- System messages, heartbeats, cron outputs
- Only URLs, dates, or numbers without personal context
- Generic statements without relation to Vector or Saphira

Resolve coreferences: "he"→"Vector", "she/I"→"Saphira", "it"→actual thing name.

Use ONLY these predicates: knows, created, uses, located_in, part_of, interested_in, prefers, works_on, related_to, has_property, occurred_at, causes.
